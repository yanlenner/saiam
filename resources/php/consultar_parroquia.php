...
$consulta = pg_query($conexion, "SELECT parroquia FROM contacto_personas where persona='$_POST[persona]'");
$respuesta= pg_fetch_array($consulta);
$consulta = pg_query($conexion, "SELECT nm_parroquia FROM parroquias where id_parroquia='$respuesta[parroquia]'");
$respuesta= pg_fetch_array($consulta);
